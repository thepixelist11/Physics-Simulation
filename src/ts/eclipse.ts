 ...
 */
export function drawPoint(ctx: CanvasRenderingContext2D, position: Vector2, color: Color, radius: number): void // Overload 1
/**
 * Draws a circular point on a canvas with a specified color and radius.
 * @param {CanvasRenderingContext2D} ctx The context to draw the point on
 ...
 * @param {number} radius The radius of the point. Defaults to 1
 */
export function drawPoint(ctx: CanvasRenderingContext2D, position: number[], color: Color, radius: number): void // Overload 2
export function drawPoint(ctx: CanvasRenderingContext2D, x: number | Vector2 | number[], y?: number | Color, radius: number = 1, color: Color = Color.BLACK) {
